		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="水果分类" prop="shuiguofenlei">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.shuiguofenlei?true:false"
								v-model="form.shuiguofenlei" 
								placeholder="请选择水果分类"
								>
								<el-option v-for="(item,index) in shuiguofenleiLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="12">
						<el-form-item label="水果详情" prop="shuiguoxiangqing">
							<editor :value="form.shuiguoxiangqing" placeholder="请输入水果详情" :readonly="!isAdd||disabledForm.shuiguoxiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'shuiguoxiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.shuiguoxiangqing = res.data.data.shuiguoxiangqing?(res.data.data.shuiguoxiangqing.replace(reg,'../../../cl87035199/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shuiguofenlei'){
					form.value.shuiguofenlei = row[x];
					disabledForm.value.shuiguofenlei = true;
					continue;
				}
				if(x=='guige'){
				...
				if(x=='shuiguoxiangqing'){
					form.value.shuiguoxiangqing = row[x];
					disabledForm.value.shuiguoxiangqing = true;
					continue;
				}
				if(x=='storeupnum'){
